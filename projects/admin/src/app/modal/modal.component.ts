...
console.log(this.operation);
  ...
  this.http.post('https://app-250220182315.azurewebsites.net/home/save/', formData).subscribe(
    (response:any) => {
      this.modalRef.close()
    ...
    (error) => {
      ...
      this.http.post('https://app-250220182315.azurewebsites.net/service/serviceRequest/', formData).subscribe(
        (response) => {
